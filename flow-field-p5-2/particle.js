...
class Particle {
	...
	this.wrapped = false
	this.framesAlive = 0
	this.color = ['#ECAFC9','#E1C9FF'][Math.floor(Math.random()*2)]
    }
...
*/
	...
	if (this.framesAlive < orientationPeriod
	    || this.framesAlive > orientationPeriod + drawPeriod ) {
	...
	let clrVar = (this.lastFieldVal + 1) / 2
	let final = lerpColor(color1, color2, clrVar)
	stroke(this.color)
